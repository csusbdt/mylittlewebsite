...
const play_0 = _ => {
	...
	// 	g_0.gain.cancelScheduledValues(audio.currentTime);
	// }
    const saved = JSON.parse('[[0,76.60852072310405,0.5361111111111111],[0.8613333333333344,51.9171626984127,0.34444444444444444],[1.4613333333333287,49.04017857142857,0.6222222222222222],[2.1813333333333276,90.26592813051145,0.43888888888888894],[2.74133333333333,259.35763888888897,0.3111111111111111],[3.170666666666662,192.79017857142858,0.6694444444444445],[3.541333333333327,65.11160714285714,0.6805555555555556],[3.8613333333333344,54.61777998236332,0.45],[4.152000000000001,151.9171626984127,0.3166666666666667],[4.432000000000002,248.50005511463849,0.25833333333333336],[4.6613333333333316,272.7504960317461,0.24444444444444446],[4.920000000000002,330.29017857142856,0.23333333333333334],[5.200000000000003,446.2624007936509,0.225],[5.450666666666663,408.2884149029982,0.375],[5.701333333333324,246.36160714285714,0.5222222222222223],[5.941333333333333,153.4934413580247,0.4638888888888889],[6.170666666666662,133.86160714285714,0.3388888888888889],[6.439999999999998,96.78047839506173,0.30277777777777776]]');
	snapshots.length = 0;
	saved.forEach(snapshot => { snapshots.push(snapshot); });
	play_duration = 7.1413333333333355;
	play_snapshots();
};
