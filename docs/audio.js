...
const play_0 = _ => {
	...
	if (audio.state === "suspended") audio.resume();
	if (g_0 === null) start_audio();	
    const saved = JSON.parse('[[0,77,0.50],[0.86,52,0.34],[1.46,49,0.62],[2.18,90,0.44],[2.74,259,0.31],[3.17,193,0.67],[3.54,65,0.68],[3.86,55,0.45],[4.15,152,0.32],[4.43,248,0.258],[4.66,273,0.24],[4.92,330,0.23],[5.20,446,0.225],[5.45,408,0.375],[5.70,246,0.52],[5.94,153,0.464],[6.17,134,0.339],[6.44,97,0.303]]');
	snapshots.length = 0;
